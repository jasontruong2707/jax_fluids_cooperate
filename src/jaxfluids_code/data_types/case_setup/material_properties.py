...
# Add class for power law
class PowerlawParameters(NamedTuple):
    """ Parameters of the Power-Law model for Non-Newtonian fluid

    value = K_ref * (gamma_dot^(n_ref - 1))

    K_ref: power law consistency 
    n_ref: power consistency
...
class DynamicViscositySetup(NamedTuple):
    ...
    powerlaw_parameters: PowerlawParameters = None # Add here
